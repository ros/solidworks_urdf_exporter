...
namespace SW2SDF
{
    ...
    public class SDFWriter
    {
        ...
        public SDFWriter(string savePath)
        {
    ...
    public class inertial : SDFElement
    {
    ...
    public class origin : SDFElement
    {
    ...
    public class inertia : SDFElement
    {
    ...
    public class visual : SDFElement
    {
        public origin Origin;
    ...
    public class texture : SDFElement
    {
        private Attribute Filename;
        public string filename
        {
    ...
    public class collision : SDFElement
    {
        public origin Origin;
        public geometry Geometry;
    ...
    public class parent_link : SDFElement
    {
        private Attribute Name;
        public string name
        {
    ...
    public class child_link : SDFElement
    {
        private Attribute Name;
        public string name
        {
    ...
    public class calibration : SDFElement
    {
    ...
    public class dynamics : SDFElement
    {
    ...
    public class safety_controller : SDFElement
    {
